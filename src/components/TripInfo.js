    ...
    if ('geolocation' in navigator) {
      navigator.geolocation.getCurrentPosition(
        async (position) => {
          ...
          const distance = lastKnownLocation ? getDistance(lastKnownLocation.lat, lastKnownLocation.lng, snappedPosition.lat, snappedPosition.lng) : 31;

          if (forceUpdate || distance > 30) {
